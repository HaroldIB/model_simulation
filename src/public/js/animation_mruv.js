...
function initMoto() {
  camion = new ImageParticle("/img/camion.png", camionWidth, camionHeight);
...
function loadAndDrawImage() {
  ...
  background.image.src = "/img/background_mruv.jpg";
  initGraphs();
}
...
background = new Background("/img/background_mruv.jpg", canvas, context);
